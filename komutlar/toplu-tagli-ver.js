...
await x.roles.add(roller.tagli)
await x.setNickname(x.displayName.replace(botconfig.tagg, botconfig.tag))
})
...
exports.conf = {
  aliases: ['rolver', 'senkronize', 'taglıver', 'tagliver'],
};
  
exports.help = {
  name: 'Senkronize Komutu',
};
